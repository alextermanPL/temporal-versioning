...
section "STEP 1 — Baseline: working payment workflow"

git checkout "$COMMIT_BASELINE" --quiet
echo "  Checked out baseline (tag: $COMMIT_BASELINE)"
...
section "STEP 2 — Breaking change: fraudCheck inserted before reserveFunds"

git checkout "$COMMIT_BREAKING" --quiet
echo "  Checked out breaking change (tag: $COMMIT_BREAKING)"
